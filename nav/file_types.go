...
func GetOutputPathOfGlobalImageFile(inputPath string, packages []gruntwork_package.GruntworkPackage) (string, error) {
...
func GetOutputPathOfGlobalNonimageFile(inputPath string, packages []gruntwork_package.GruntworkPackage) (string, error) {
	var outputPath string
...
func GetOutputPathOfModuleImageFile(inputPath string, packages []gruntwork_package.GruntworkPackage) (string, error) {
	var outputPath string
...
func GetOutputPathOfModuleNonimageFile(inputPath string, packages []gruntwork_package.GruntworkPackage) (string, error) {
	var outputPath string
