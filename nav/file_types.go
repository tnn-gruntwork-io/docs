...
func GetOutputPathOfGlobalImageFile(inputPath string) string {
	...
	if len(submatches) == 0 || len(submatches[0]) != IS_GLOBAL_IMAGE_FILE_REGEX_NUM_CAPTURE_GROUPS + 1 {
		return outputPath, errors.WithStackTrace(&WrongNumberOfCaptureGroupsReturnedFromRegEx{inputPath: inputPath, regExName: "IS_GLOBAL_IMAGE_FILE_REGEX", regEx: IS_GLOBAL_IMAGE_FILE_REGEX })
	}
...
func GetOutputPathOfGlobalNonimageFile(inputPath string) string {
	var outputPath string
	...
	if len(submatches) == 0 || len(submatches[0]) != IS_GLOBAL_NONIMAGE_FILE_REGEX_NUM_CAPTURE_GROUPS + 1 {
		return outputPath, errors.WithStackTrace(&WrongNumberOfCaptureGroupsReturnedFromRegEx{inputPath: inputPath, regExName: "IS_GLOBAL_NONIMAGE_FILE_REGEX", regEx: IS_GLOBAL_NONIMAGE_FILE_REGEX })
	}
...
func GetOutputPathOfModuleImageFile(inputPath string) string {
	var outputPath string
	...
	if len(submatches) == 0 || len(submatches[0]) != IS_MODULE_IMAGE_FILE_REGEX_NUM_CAPTURE_GROUPS + 1 {
		return outputPath, errors.WithStackTrace(&WrongNumberOfCaptureGroupsReturnedFromRegEx{inputPath: inputPath, regExName: "IS_MODULE_IMAGE_FILE_REGEX", regEx: IS_MODULE_IMAGE_FILE_REGEX })
	}
...
func GetOutputPathOfModuleNonimageFile(inputPath string) string {
	var outputPath string
	...
	if len(submatches) == 0 || len(submatches[0]) != IS_MODULE_NONIMAGE_FILE_REGEX_NUM_CAPTURE_GROUPS + 1 {
		return outputPath, errors.WithStackTrace(&WrongNumberOfCaptureGroupsReturnedFromRegEx{inputPath: inputPath, regExName: "IS_MODULE_NONIMAGE_FILE_REGEX", regEx: IS_MODULE_NONIMAGE_FILE_REGEX })
	}
	...
	outputPath = fmt.Sprintf("packages/%s/_images/%s", packageName, fileName)
