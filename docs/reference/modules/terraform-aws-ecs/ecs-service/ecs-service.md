...
<<<<<<< Updated upstream
<a href="https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/releases/tag/v0.34.2" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>

This module creates an [Elastic Container Service (ECS) Service](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) that you can use to run one or more related, long-running Docker containers, such as a web service. An ECS service can automatically deploy multiple instances of your Docker containers across an ECS cluster (see the [ecs-cluster module](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-cluster)), restart any failed Docker containers, route traffic across your containers using an optional Elastic Load Balancer (ELB), and optionally register the services to AWS Service Discovery Service.
=======
<a href="https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/tnn-gruntwork-io/terraform-aws-ecs/releases/tag/v0.34.2" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>

This module creates an [Elastic Container Service (ECS) Service](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) that you can use to run one or more related, long-running Docker containers, such as a web service. An ECS service can automatically deploy multiple instances of your Docker containers across an ECS cluster (see the [ecs-cluster module](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-cluster)), restart any failed Docker containers, route traffic across your containers using an optional Elastic Load Balancer (ELB), and optionally register the services to AWS Service Discovery Service.
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   Verified deployments using the [ECS deployment checker binary](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy-check-binaries)
=======
*   Verified deployments using the [ECS deployment checker binary](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy-check-binaries)
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   [What is Amazon ECS?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#what-is-elastic-container-service)

*   [Helpful vocabulary for ECS](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#helpful-vocabulary)

*   [What is Fargate?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#what-is-fargate)

*   [What is an ECS Service?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#what-is-an-ecs-service)

*   [What is ECS Service Discovery?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#what-is-ecs-service-discovery)
=======
*   [What is Amazon ECS?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#what-is-elastic-container-service)

*   [Helpful vocabulary for ECS](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#helpful-vocabulary)

*   [What is Fargate?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#what-is-fargate)

*   [What is an ECS Service?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#what-is-an-ecs-service)

*   [What is ECS Service Discovery?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#what-is-ecs-service-discovery)
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   [modules](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal submodules.

    *   [modules/ecs-cluster](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-cluster): use this module to provision an ECS cluster with ECS container instances.

    *   [modules/ecs-scripts](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-scripts): use the scripts in this module to configure private docker registries and register ECS container instances to ECS clusters.

    *   [modules/ecs-service](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service): use this module to deploy one or more docker containers as a ECS service, with options to use ELBs (CLB, ALB, or NLB), Service Discovery, or Fargate.

    *   [modules/ecs-daemon-service](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-daemon-service): use this module to deploy one or more docker containers that run on a regular schedule.

    *   [modules/ecs-deploy](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy): use the scripts in this module to run one or more docker containers as a one time task on an ECS cluster.

    *   [modules/ecs-deploy-check-binaries](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy-check-binaries): use the python binary packages in this module to check ECS service deployments to ensure that they are active and healthy.

*   [examples](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/examples): This folder contains working examples of how to use the submodules.

*   [test](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/test): Automated tests for the modules and examples.

### Gruntwork analysis

*   [EC2 vs Fargate launch types](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#ec2-vs-fargate-launch-types): A detailed comparison between the two available launch types for ECS, showing you the trade-offs between ECS container instances and Fargate.
=======
*   [modules](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal submodules.

    *   [modules/ecs-cluster](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-cluster): use this module to provision an ECS cluster with ECS container instances.

    *   [modules/ecs-scripts](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-scripts): use the scripts in this module to configure private docker registries and register ECS container instances to ECS clusters.

    *   [modules/ecs-service](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service): use this module to deploy one or more docker containers as a ECS service, with options to use ELBs (CLB, ALB, or NLB), Service Discovery, or Fargate.

    *   [modules/ecs-daemon-service](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-daemon-service): use this module to deploy one or more docker containers that run on a regular schedule.

    *   [modules/ecs-deploy](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy): use the scripts in this module to run one or more docker containers as a one time task on an ECS cluster.

    *   [modules/ecs-deploy-check-binaries](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-deploy-check-binaries): use the python binary packages in this module to check ECS service deployments to ensure that they are active and healthy.

*   [examples](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/examples): This folder contains working examples of how to use the submodules.

*   [test](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/test): Automated tests for the modules and examples.

### Gruntwork analysis

*   [EC2 vs Fargate launch types](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/core-concepts.md#ec2-vs-fargate-launch-types): A detailed comparison between the two available launch types for ECS, showing you the trade-offs between ECS container instances and Fargate.
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   [examples folder](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
=======
*   [examples folder](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   [app account configuration](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/prod/us-west-2/prod/services/ecs-cluster/terragrunt.hcl)

*   [base configuration](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/\_envcommon/services/ecs-cluster.hcl)

*   ECS Service with ALB: examples for managing ECS services load balanced by an ALB

*   [app account configuration](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/prod/us-west-2/prod/services/ecs-sample-app-frontend/terragrunt.hcl)

*   [base configuration](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/\_envcommon/services/ecs-sample-app-frontend.hcl)
=======
*   [app account configuration](https://github.com/tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/prod/us-west-2/prod/services/ecs-cluster/terragrunt.hcl)

*   [base configuration](https://github.com/tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/\_envcommon/services/ecs-cluster.hcl)

*   ECS Service with ALB: examples for managing ECS services load balanced by an ALB

*   [app account configuration](https://github.com/tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/prod/us-west-2/prod/services/ecs-sample-app-frontend/terragrunt.hcl)

*   [base configuration](https://github.com/tnn-gruntwork-io/terraform-aws-service-catalog/blob/main/examples/for-production/infrastructure-live/\_envcommon/services/ecs-sample-app-frontend.hcl)
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
*   [How do I use Fargate?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-use-fargate)

*   [How do I associate the ECS Service with an ALB or NLB?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-associate-the-ecs-service-with-an-alb-or-nlb)

*   [How do I setup Service Discovery?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-setup-service-discovery)

*   [How do I add IAM policies to the ECS service?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-you-add-additional-iam-policies-to-the-ecs-service)

*   [How do I scale an ECS service?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-you-scale-an-ecs-service)

### Major changes

*   [How do you make changes to the EC2 instances in the cluster?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/module/ecs-cluster/README.md#how-do-you-make-changes-to-the-ec-2-instances-in-the-cluster)

*   [How do ECS Services deploy new versions of containers?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-ecs-services-deploy-new-versions-of-containers)

*   [How do I do a canary deployment?](https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-do-a-canary-deployment)
=======
*   [How do I use Fargate?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-use-fargate)

*   [How do I associate the ECS Service with an ALB or NLB?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-associate-the-ecs-service-with-an-alb-or-nlb)

*   [How do I setup Service Discovery?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-setup-service-discovery)

*   [How do I add IAM policies to the ECS service?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-you-add-additional-iam-policies-to-the-ecs-service)

*   [How do I scale an ECS service?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-you-scale-an-ecs-service)

### Major changes

*   [How do you make changes to the EC2 instances in the cluster?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/module/ecs-cluster/README.md#how-do-you-make-changes-to-the-ec-2-instances-in-the-cluster)

*   [How do ECS Services deploy new versions of containers?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-ecs-services-deploy-new-versions-of-containers)

*   [How do I do a canary deployment?](https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/core-concepts.md#how-do-i-do-a-canary-deployment)
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
  source = "git::git@github.com:tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs.git//modules/ecs-service?ref=v0.35.1"
=======
  source = "git::git@github.com:tnn-gruntwork-io/terraform-aws-ecs.git//modules/ecs-service?ref=v0.35.1"
>>>>>>> Stashed changes
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
<<<<<<< Updated upstream
    "https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/readme.adoc",
    "https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/variables.tf",
    "https://github.com/tnn-tnn-tnn-tnn-tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/outputs.tf"
=======
    "https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/readme.adoc",
    "https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/variables.tf",
    "https://github.com/tnn-gruntwork-io/terraform-aws-ecs/tree/v0.35.1/modules/ecs-service/outputs.tf"
>>>>>>> Stashed changes
  ],
